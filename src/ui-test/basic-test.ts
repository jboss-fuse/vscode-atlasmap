...
export function basicTests() {
	...
	describe('Start AtlasMap and verify correct notifications', () => {
		beforeEach(async () => {
		...
		describe('Start AtlasMap (when running) and verify correct notifications', () => {
		...
		describe('Stop AtlasMap and verify correct notification', () => {
		...
		describe('Stop already stopped AtlasMap and verify correct notification', () => {
